...
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_modelInfo(
    JNIEnv *env,
    jobject thiz,
    ...
    auto info = maputils::createWriteableMap(env);
    maputils::putInt(env, info, "version", lm_gguf_get_version(ctx));
    maputils::putInt(env, info, "alignment", lm_gguf_get_alignment(ctx));
    maputils::putInt(env, info, "data_offset", lm_gguf_get_data_offset(ctx));
    {
        ...
        for (int i = 0; i < n_kv; ++i) {
            ...
            maputils::putString(env, info, key, value.c_str());
        }
    }
...
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getBackendDevicesInfo(
    JNIEnv *env,
    jobject thiz
) {
    UNUSED(thiz);
...
std::vector<std::string> extract_media_paths(JNIEnv *env, jobject params) {
    ...
    if (mapreader::hasKey(env, params, "media_paths")) {
        jobject media_paths = mapreader::getArray(env, params, "media_paths");

        if (media_paths != nullptr) {
            int size = listreader::size(env, media_paths);
            for (int i = 0; i < size; i++) {
                jstring path_str = listreader::getString(env, media_paths, i);
...
void extract_sampling_params(
    ...
    if (mapreader::hasKey(env, params, "n_predict")) {
        cparams.n_predict = mapreader::getInt(env, params, "n_predict", -1);
    }
    if (mapreader::hasKey(env, params, "temperature")) {
        sparams.temp = mapreader::getFloat(env, params, "temperature", 0.7f);
    }
    if (mapreader::hasKey(env, params, "top_k")) {
        sparams.top_k = mapreader::getInt(env, params, "top_k", 40);
    }
    if (mapreader::hasKey(env, params, "top_p")) {
        sparams.top_p = mapreader::getFloat(env, params, "top_p", 0.95f);
    }
    if (mapreader::hasKey(env, params, "min_p")) {
        sparams.min_p = mapreader::getFloat(env, params, "min_p", 0.05f);
    }
    if (mapreader::hasKey(env, params, "xtc_threshold")) {
        sparams.xtc_threshold = mapreader::getFloat(env, params, "xtc_threshold", 0.1f);
    }
    if (mapreader::hasKey(env, params, "xtc_probability")) {
        sparams.xtc_probability = mapreader::getFloat(env, params, "xtc_probability", 0.0f);
    }
    if (mapreader::hasKey(env, params, "typical_p")) {
        sparams.typ_p = mapreader::getFloat(env, params, "typical_p", 1.0f);
    }

    // Penalty parameters
    if (mapreader::hasKey(env, params, "penalty_last_n")) {
        sparams.penalty_last_n = mapreader::getInt(env, params, "penalty_last_n", 64);
    }
    if (mapreader::hasKey(env, params, "penalty_repeat")) {
        sparams.penalty_repeat = mapreader::getFloat(env, params, "penalty_repeat", 1.0f);
    }
    if (mapreader::hasKey(env, params, "penalty_freq")) {
        sparams.penalty_freq = mapreader::getFloat(env, params, "penalty_freq", 0.0f);
    }
    if (mapreader::hasKey(env, params, "penalty_present")) {
        sparams.penalty_present = mapreader::getFloat(env, params, "penalty_present", 0.0f);
    }

    // Mirostat parameters
    if (mapreader::hasKey(env, params, "mirostat")) {
        sparams.mirostat = mapreader::getInt(env, params, "mirostat", 0);
    }
    if (mapreader::hasKey(env, params, "mirostat_tau")) {
        sparams.mirostat_tau = mapreader::getFloat(env, params, "mirostat_tau", 5.0f);
    }
    if (mapreader::hasKey(env, params, "mirostat_eta")) {
        sparams.mirostat_eta = mapreader::getFloat(env, params, "mirostat_eta", 0.1f);
    }

    // DRY parameters
    if (mapreader::hasKey(env, params, "dry_multiplier")) {
        sparams.dry_multiplier = mapreader::getFloat(env, params, "dry_multiplier", 0.0f);
    }
    if (mapreader::hasKey(env, params, "dry_base")) {
        sparams.dry_base = mapreader::getFloat(env, params, "dry_base", 1.75f);
    }
    if (mapreader::hasKey(env, params, "dry_allowed_length")) {
        sparams.dry_allowed_length = mapreader::getInt(env, params, "dry_allowed_length", 2);
    }
    if (mapreader::hasKey(env, params, "dry_penalty_last_n")) {
        sparams.dry_penalty_last_n = mapreader::getInt(env, params, "dry_penalty_last_n", -1);
    }

    // DRY sequence breakers
    if (mapreader::hasKey(env, params, "dry_sequence_breakers")) {
        jobject dry_sequence_breakers = mapreader::getArray(env, params, "dry_sequence_breakers");

        sparams.dry_sequence_breakers.clear();
        int size = listreader::size(env, dry_sequence_breakers);
        for (int i = 0; i < size; i++) {
            jstring str = listreader::getString(env, dry_sequence_breakers, i);
    ...
    // Other parameters
    if (mapreader::hasKey(env, params, "top_n_sigma")) {
        sparams.top_n_sigma = mapreader::getFloat(env, params, "top_n_sigma", -1.0f);
    }
    if (mapreader::hasKey(env, params, "n_probs")) {
        sparams.n_probs = mapreader::getInt(env, params, "n_probs", 0);
    }
    if (mapreader::hasKey(env, params, "seed")) {
        jint seed = mapreader::getInt(env, params, "seed", -1);
        sparams.seed = (seed == -1) ? time(NULL) : seed;
    }
    if (mapreader::hasKey(env, params, "ignore_eos")) {
        sparams.ignore_eos = mapreader::getBool(env, params, "ignore_eos", false);
    }

    // Grammar parameters
    if (mapreader::hasKey(env, params, "grammar")) {
        jstring grammar = mapreader::getString(env, params, "grammar", nullptr);
    ...
    if (mapreader::hasKey(env, params, "grammar_lazy")) {
        sparams.grammar_lazy = mapreader::getBool(env, params, "grammar_lazy", false);
    }

    // JSON schema to grammar conversion
    if (mapreader::hasKey(env, params, "json_schema") && !mapreader::hasKey(env, params, "grammar")) {
        jstring json_schema = mapreader::getString(env, params, "json_schema", nullptr);
    ...
    // Stop sequences
    if (mapreader::hasKey(env, params, "stop")) {
        jobject stop_array = mapreader::getArray(env, params, "stop");

        cparams.antiprompt.clear();
        int size = listreader::size(env, stop_array);
        for (int i = 0; i < size; i++) {
            jstring str = listreader::getString(env, stop_array, i);
            const char *chars = env->GetStringUTFChars(str, nullptr);
    ...
    // Logit bias
    if (mapreader::hasKey(env, params, "logit_bias")) {
        jobject logit_bias_array = mapreader::getArray(env, params, "logit_bias");

        int size = listreader::size(env, logit_bias_array);
        for (int i = 0; i < size; i++) {
            jobject row_array = listreader::getMap(env, logit_bias_array, i);
    ...
    if (mapreader::hasKey(env, params, "ignore_eos") && mapreader::getBool(env, params, "ignore_eos", false)) {
    ...
    if (mapreader::hasKey(env, params, "preserved_tokens")) {
        jobject preserved_tokens = mapreader::getArray(env, params, "preserved_tokens");

        int preserved_tokens_size = listreader::size(env, preserved_tokens);
        for (int i = 0; i < preserved_tokens_size; i++) {
            jstring preserved_token = listreader::getString(env, preserved_tokens, i);
    ...
    if (mapreader::hasKey(env, params, "grammar_triggers")) {
        jobject grammar_triggers = mapreader::getArray(env, params, "grammar_triggers");

        int grammar_triggers_size = listreader::size(env, grammar_triggers);
        for (int i = 0; i < grammar_triggers_size; i++) {
            auto trigger_map = listreader::getMap(env, grammar_triggers, i);
            const auto type = static_cast<common_grammar_trigger_type>(mapreader::getInt(env, trigger_map, "type", 0));
            jstring trigger_word = mapreader::getString(env, trigger_map, "value", nullptr);
            ...
            if (type == COMMON_GRAMMAR_TRIGGER_TYPE_WORD) {
                ...
                if (type == COMMON_GRAMMAR_TRIGGER_TYPE_TOKEN) {
                    ...
                    trigger.token = (llama_token) mapreader::getInt(env, trigger_map, "token", 0);
                }
                sparams.grammar_triggers.push_back(std::move(trigger));
            }
        }
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_initContext(
    JNIEnv *env,
    jobject thiz,
    jobject params_map,
    ...
    jstring model_path_str = mapreader::getString(env, params_map, "model", nullptr);
    if (!model_path_str) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "_error", "Missing required parameter: model");
        return result;
    }
    ...
    if (mapreader::hasKey(env, params_map, "chat_template")) {
        chat_template = mapreader::getString(env, params_map, "chat_template", nullptr);
        if (chat_template) {
    ...
    if (mapreader::hasKey(env, params_map, "vocab_only")) {
        vocab_only = mapreader::getBool(env, params_map, "vocab_only", false);
    ...
    if (mapreader::hasKey(env, params_map, "n_ctx")) {
        defaultParams.n_ctx = mapreader::getInt(env, params_map, "n_ctx", 512);
    }
    if (mapreader::hasKey(env, params_map, "n_batch")) {
        defaultParams.n_batch = mapreader::getInt(env, params_map, "n_batch", 512);
    }
    if (mapreader::hasKey(env, params_map, "n_ubatch")) {
        defaultParams.n_ubatch = mapreader::getInt(env, params_map, "n_ubatch", 512);
    }
    if (mapreader::hasKey(env, params_map, "n_parallel")) {
        jint n_parallel = mapreader::getInt(env, params_map, "n_parallel", 0);
        if (n_parallel > 0) {
            defaultParams.n_parallel = n_parallel;
        }
    }
    if (mapreader::hasKey(env, params_map, "ctx_shift")) {
        defaultParams.ctx_shift = mapreader::getBool(env, params_map, "ctx_shift", true);
    }
    if (mapreader::hasKey(env, params_map, "kv_unified")) {
        defaultParams.kv_unified = mapreader::getBool(env, params_map, "kv_unified", false);
    }
    if (mapreader::hasKey(env, params_map, "swa_full")) {
        defaultParams.swa_full = mapreader::getBool(env, params_map, "swa_full", false);
    }

    // Handle n_cpu_moe parameter
    if (mapreader::hasKey(env, params_map, "n_cpu_moe")) {
        jint n_cpu_moe = mapreader::getInt(env, params_map, "n_cpu_moe", 0);
        if (n_cpu_moe > 0) {
    ...
    if (mapreader::hasKey(env, params_map, "pooling_type")) {
        jint pooling_type = mapreader::getInt(env, params_map, "pooling_type", -1);
        if (pooling_type != -1) {
    ...
    if (mapreader::hasKey(env, params_map, "embedding")) {
        embedding = mapreader::getBool(env, params_map, "embedding", false);
        defaultParams.embedding = embedding;
    }
    if (mapreader::hasKey(env, params_map, "embd_normalize")) {
        jint embd_normalize = mapreader::getInt(env, params_map, "embd_normalize", -1);
        if (embd_normalize != -1) {
    ...
    if (mapreader::hasKey(env, params_map, "n_threads")) {
        n_threads = mapreader::getInt(env, params_map, "n_threads", n_threads);
    }
    set_best_cores(defaultParams.cpuparams, n_threads);

    // Extract GPU parameters
    if (mapreader::hasKey(env, params_map, "n_gpu_layers")) {
        defaultParams.n_gpu_layers = mapreader::getInt(env, params_map, "n_gpu_layers", 0);
    }

    // Extract flash attention parameters
    jstring flash_attn_type_str = nullptr;
    const char *flash_attn_type_chars = nullptr;
    if (mapreader::hasKey(env, params_map, "flash_attn_type")) {
        flash_attn_type_str = mapreader::getString(env, params_map, "flash_attn_type", nullptr);
    ...
    } else if (mapreader::hasKey(env, params_map, "flash_attn")) {
        // DEPRECATED: use flash_attn_type instead
        bool flash_attn = mapreader::getBool(env, params_map, "flash_attn", false);
    ...
    if (mapreader::hasKey(env, params_map, "cache_type_k")) {
        cache_type_k = mapreader::getString(env, params_map, "cache_type_k", nullptr);
        if (cache_type_k) {
    ...
    if (mapreader::hasKey(env, params_map, "cache_type_v")) {
        cache_type_v = mapreader::getString(env, params_map, "cache_type_v", nullptr);
        if (cache_type_v) {
    ...
    if (mapreader::hasKey(env, params_map, "use_mlock")) {
        defaultParams.use_mlock = mapreader::getBool(env, params_map, "use_mlock", true);
    }
    if (mapreader::hasKey(env, params_map, "use_mmap")) {
        defaultParams.use_mmap = mapreader::getBool(env, params_map, "use_mmap", true);
    }

    // Extract RoPE parameters
    if (mapreader::hasKey(env, params_map, "rope_freq_base")) {
        defaultParams.rope_freq_base = mapreader::getFloat(env, params_map, "rope_freq_base", 0.0f);
    }
    if (mapreader::hasKey(env, params_map, "rope_freq_scale")) {
        defaultParams.rope_freq_scale = mapreader::getFloat(env, params_map, "rope_freq_scale", 0.0f);
    }
    ...
    if (mapreader::hasKey(env, params_map, "lora")) {
        lora_str = mapreader::getString(env, params_map, "lora", nullptr);
        if (lora_str) {
            ...
            if (lora_chars != nullptr && lora_chars[0] != '\0') {
                ...
                if (mapreader::hasKey(env, params_map, "lora_scaled")) {
                    la.scale = mapreader::getFloat(env, params_map, "lora_scaled", 1.0f);
                } else {
                    la.scale = 1.0f;
                }
                lora.push_back(la);
    ...
    if (mapreader::hasKey(env, params_map, "lora_list")) {
        jobject lora_list = mapreader::getArray(env, params_map, "lora_list");

        if (lora_list != nullptr) {
            // lora_adapters: ReadableArray<ReadableMap>
            int lora_list_size = listreader::size(env, lora_list);
            for (int i = 0; i < lora_list_size; i++) {
                jobject lora_adapter = listreader::getMap(env, lora_list, i);
                jstring path = mapreader::getString(env, lora_adapter, "path", nullptr);
                if (path != nullptr) {
                    const char *path_chars = env->GetStringUTFChars(path, nullptr);
                    common_adapter_lora_info la;
                    la.path = path_chars;
                    la.scale = mapreader::getFloat(env, lora_adapter, "scaled", 1.0f);
                    lora.push_back(la);
    ...
    auto result_map = maputils::createWriteableMap(env);

    const auto context_ptr = reinterpret_cast<intptr_t>(llama->ctx);
    const std::string context_str = std::to_string(context_ptr);

    maputils::putString(env, result_map, "context", context_str.c_str());
    maputils::putBoolean(env, result_map, "gpu", gpu_used);
    maputils::putString(env, result_map, "reasonNoGPU", reason_no_gpu.c_str());
    if (gpu_used && !gpu_device_name.empty()) {
        maputils::putString(env, result_map, "gpuDevice", gpu_device_name.c_str());
    }
...
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_interruptLoad(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_loadModelDetails(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
    ...
    auto meta = maputils::createWriteableMap(env);
    for (int i = 0; i < count; i++) {
        ...
        maputils::putString(env, meta, key, val);
    }
    ...
    maputils::putString(env, result, "desc", desc);
    maputils::putDouble(env, result, "size", llama_model_size(llama->model));
    maputils::putDouble(env, result, "nEmbd", llama_model_n_embd(llama->model));
    maputils::putDouble(env, result, "nParams", llama_model_n_params(llama->model));
    auto chat_templates = maputils::createWriteableMap(env);
    maputils::putBoolean(env, chat_templates, "llamaChat", llama->validateModelChatTemplate(false, nullptr));

    auto minja = maputils::createWriteableMap(env);
    maputils::putBoolean(env, minja, "default", llama->validateModelChatTemplate(true, nullptr));

    auto default_caps = maputils::createWriteableMap(env);

    auto default_tmpl = llama->templates.get()->template_default.get();
    auto default_tmpl_caps = default_tmpl->original_caps();
    maputils::putBoolean(env, default_caps, "tools", default_tmpl_caps.supports_tools);
    maputils::putBoolean(env, default_caps, "toolCalls", default_tmpl_caps.supports_tool_calls);
    maputils::putBoolean(env, default_caps, "parallelToolCalls", default_tmpl_caps.supports_parallel_tool_calls);
    maputils::putBoolean(env, default_caps, "toolResponses", default_tmpl_caps.supports_tool_responses);
    maputils::putBoolean(env, default_caps, "systemRole", default_tmpl_caps.supports_system_role);
    maputils::putBoolean(env, default_caps, "toolCallId", default_tmpl_caps.supports_tool_call_id);
    maputils::putMap(env, minja, "defaultCaps", default_caps);

    maputils::putBoolean(env, minja, "toolUse", llama->validateModelChatTemplate(true, "tool_use"));
    auto tool_use_tmpl = llama->templates.get()->template_tool_use.get();
    if (tool_use_tmpl != nullptr) {
      auto tool_use_caps = maputils::createWriteableMap(env);
      auto tool_use_tmpl_caps = tool_use_tmpl->original_caps();
      maputils::putBoolean(env, tool_use_caps, "tools", tool_use_tmpl_caps.supports_tools);
      maputils::putBoolean(env, tool_use_caps, "toolCalls", tool_use_tmpl_caps.supports_tool_calls);
      maputils::putBoolean(env, tool_use_caps, "parallelToolCalls", tool_use_tmpl_caps.supports_parallel_tool_calls);
      maputils::putBoolean(env, tool_use_caps, "systemRole", tool_use_tmpl_caps.supports_system_role);
      maputils::putBoolean(env, tool_use_caps, "toolResponses", tool_use_tmpl_caps.supports_tool_responses);
      maputils::putBoolean(env, tool_use_caps, "toolCallId", tool_use_tmpl_caps.supports_tool_call_id);
      maputils::putMap(env, minja, "toolUseCaps", tool_use_caps);
    }

    maputils::putMap(env, chat_templates, "minja", minja);
    maputils::putMap(env, result, "metadata", meta);
    maputils::putMap(env, result, "chatTemplates", chat_templates);

    // deprecated
    maputils::putBoolean(env, result, "isChatTemplateSupported", llama->validateModelChatTemplate(false, nullptr));

    return reinterpret_cast<jobject>(result);
}

JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getFormattedChatWithJinja(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring messages,
    ...
    jstring json_schema = mapreader::hasKey(env, params, "json_schema") ?
        mapreader::getString(env, params, "json_schema", nullptr) : nullptr;
    const char *json_schema_chars = json_schema ? env->GetStringUTFChars(json_schema, nullptr) : "";

    jstring tools = mapreader::hasKey(env, params, "tools") ?
        mapreader::getString(env, params, "tools", nullptr) : nullptr;
    const char *tools_chars = tools ? env->GetStringUTFChars(tools, nullptr) : "";

    jstring tool_choice = mapreader::hasKey(env, params, "tool_choice") ?
        mapreader::getString(env, params, "tool_choice", nullptr) : nullptr;
    const char *tool_choice_chars = tool_choice ? env->GetStringUTFChars(tool_choice, nullptr) : "";

    jstring now_str = mapreader::hasKey(env, params, "now_str") ?
        mapreader::getString(env, params, "now_str", nullptr) : nullptr;
    const char *now_chars = now_str ? env->GetStringUTFChars(now_str, nullptr) : "";

    jstring chat_template_kwargs = mapreader::hasKey(env, params, "chat_template_kwargs") ?
        mapreader::getString(env, params, "chat_template_kwargs", nullptr) : nullptr;
    const char *kwargs_chars = chat_template_kwargs ? env->GetStringUTFChars(chat_template_kwargs, nullptr) : "";

    // Extract boolean parameters
    jboolean parallel_tool_calls = mapreader::hasKey(env, params, "parallel_tool_calls") ?
        mapreader::getBool(env, params, "parallel_tool_calls", false) : false;

    jboolean enable_thinking = mapreader::hasKey(env, params, "enable_thinking") ?
        mapreader::getBool(env, params, "enable_thinking", false) : false;

    jboolean add_generation_prompt = mapreader::hasKey(env, params, "add_generation_prompt") ?
        mapreader::getBool(env, params, "add_generation_prompt", true) : true;
    ...
    try {
        ...
        maputils::putString(env, result, "prompt", formatted.prompt.c_str());
        maputils::putInt(env, result, "chat_format", static_cast<int>(formatted.format));
        maputils::putString(env, result, "grammar", formatted.grammar.c_str());
        maputils::putBoolean(env, result, "grammar_lazy", formatted.grammar_lazy);
        auto grammar_triggers = listutils::createWritableArray(env);
        for (const auto &trigger : formatted.grammar_triggers) {
            auto trigger_map = maputils::createWriteableMap(env);
            maputils::putInt(env, trigger_map, "type", trigger.type);
            maputils::putString(env, trigger_map, "value", trigger.value.c_str());
            maputils::putInt(env, trigger_map, "token", trigger.token);
            listutils::pushMap(env, grammar_triggers, trigger_map);
        }
        maputils::putBoolean(env, result, "thinking_forced_open", formatted.thinking_forced_open);
        maputils::putArray(env, result, "grammar_triggers", grammar_triggers);
        auto preserved_tokens = listutils::createWritableArray(env);
        for (const auto &token : formatted.preserved_tokens) {
            listutils::pushString(env, preserved_tokens, token.c_str());
        }
        maputils::putArray(env, result, "preserved_tokens", preserved_tokens);
        auto additional_stops = listutils::createWritableArray(env);
        for (const auto &stop : formatted.additional_stops) {
            listutils::pushString(env, additional_stops, stop.c_str());
        }
        maputils::putArray(env, result, "additional_stops", additional_stops);
        ...
        maputils::putString(env, result, "_error", errorMessage.c_str());
        maputils::putString(env, result, "_error_type", "json_parse_error");
...
JNIEXPORT jstring JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getFormattedChat(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring messages,
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_loadSession(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring path
    ...
    if (llama->completion == nullptr) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Context has been released");
        return reinterpret_cast<jobject>(result);
    }
    ...
    if (!llama_state_load_file(llama->ctx, path_chars, llama->completion->embd.data(), llama->completion->embd.capacity(), &n_token_count_out)) {
      ...
      maputils::putString(env, result, "error", "Failed to load session");
      return reinterpret_cast<jobject>(result);
    }
    ...
    maputils::putInt(env, result, "tokens_loaded", n_token_count_out);
    maputils::putString(env, result, "prompt", text.c_str());
    return reinterpret_cast<jobject>(result);
}

JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_saveSession(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring path,
    ...
    if (llama->completion == nullptr) {
        maputils::putString(env, result, "error", "Context has been released");
        maputils::putInt(env, result, "tokens_saved", 0);
        return result;
    }
    ...
    if (!llama_state_save_file(llama->ctx, path_chars, session_tokens.data(), save_size)) {
      env->ReleaseStringUTFChars(path, path_chars);
      maputils::putString(env, result, "error", "Failed to save session file");
      maputils::putInt(env, result, "tokens_saved", 0);
      return result;
    }

    env->ReleaseStringUTFChars(path, path_chars);
    maputils::putInt(env, result, "tokens_saved", save_size);
    return result;
}
...
static inline jobject tokenProbsToMap(
  ...
  std::vector<rnllama::completion_token_output> probs
    ...
    auto result = listutils::createWritableArray(env);
    for (const auto &prob : probs) {
        auto probsForToken = listutils::createWritableArray(env);
        for (const auto &p : prob.probs) {
            std::string tokStr = rnllama::tokens_to_output_formatted_string(llama->ctx, p.tok);
            auto probResult = maputils::createWriteableMap(env);
            maputils::putString(env, probResult, "tok_str", tokStr.c_str());
            maputils::putDouble(env, probResult, "prob", p.prob);
            listutils::pushMap(env, probsForToken, probResult);
        }
        std::string tokStr = rnllama::tokens_to_output_formatted_string(llama->ctx, prob.tok);
        auto tokenResult = maputils::createWriteableMap(env);
        maputils::putString(env, tokenResult, "content", tokStr.c_str());
        maputils::putArray(env, tokenResult, "probs", probsForToken);
        listutils::pushMap(env, result, tokenResult);
    }
    return result;
}
...
static inline jobject tokensToArray(
    ...
    for (const auto &token : tokens) {
        listutils::pushInt(env, result, token);
    }
    return result;
}

JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_doCompletion(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jobject params,
    ...
    jstring prompt = mapreader::getString(env, params, "prompt", nullptr);
    if (!prompt) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Missing required parameter: prompt");
        return reinterpret_cast<jobject>(result);
    }
    ...
    if (mapreader::hasKey(env, params, "prefill_text")) {
        jstring prefill_text = mapreader::getString(env, params, "prefill_text", nullptr);
    ...
    if (mapreader::hasKey(env, params, "guide_tokens")) {
        jobject guide_tokens_array = mapreader::getArray(env, params, "guide_tokens");

        int size = listreader::size(env, guide_tokens_array);
    ...
    if (!media_paths_vector.empty() && !llama->isMultimodalEnabled()) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Multimodal support not enabled. Call initMultimodal first.");
    ...
    if (mapreader::hasKey(env, params, "n_threads")) {
        jint n_threads = mapreader::getInt(env, params, "n_threads", 0);
        set_best_cores(llama->params.cpuparams, n_threads);
    }

    // Set n_predict if provided
    if (mapreader::hasKey(env, params, "n_predict")) {
        llama->params.n_predict = mapreader::getInt(env, params, "n_predict", -1);
    }

    // Set ignore_eos if provided
    if (mapreader::hasKey(env, params, "ignore_eos")) {
        llama->params.sampling.ignore_eos = mapreader::getBool(env, params, "ignore_eos", false);
    }
    ...
    if (!llama->completion->initSampling()) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Failed to initialize sampling");
        return reinterpret_cast<jobject>(result);
    }

    // Extract chat_format if provided (defaults to 0)
    jint chat_format = 0;
    if (mapreader::hasKey(env, params, "chat_format")) {
        chat_format = mapreader::getInt(env, params, "chat_format", 0);
    }
    ...
    if (mapreader::hasKey(env, params, "reasoning_format")) {
        jstring reasoning_format = mapreader::getString(env, params, "reasoning_format", nullptr);
    ...
    if (mapreader::hasKey(env, params, "thinking_forced_open")) {
        thinking_forced_open = mapreader::getBool(env, params, "thinking_forced_open", false);
    }
    ...
    try {
        ...
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", e.what());
        return reinterpret_cast<jobject>(result);
    } catch (const std::runtime_error& e) {
        llama->completion->endCompletion();
        auto result = maputils::createWriteableMap(env);
    ...
    if (llama->completion->context_full) {
        llama->completion->endCompletion();
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Context is full");
        return reinterpret_cast<jobject>(result);
    }
    ...
    while (llama->completion->has_next_token && !llama->completion->is_interrupted) {
        ...
        if (
            ...
            auto tokenResult = maputils::createWriteableMap(env);
            maputils::putString(env, tokenResult, "token", to_send.c_str());
            ...
            if (llama->params.sampling.n_probs > 0) {
              ...
              maputils::putArray(env, tokenResult, "completion_probabilities", tokenProbsToMap(env, llama, probs_output));
            }

            auto partial_output = llama->completion->parseChatOutput(true);
            if (!partial_output.content.empty()) {
                maputils::putString(env, tokenResult, "content", partial_output.content.c_str());
            }

            if (!partial_output.reasoning_content.empty()) {
                maputils::putString(env, tokenResult, "reasoning_content", partial_output.reasoning_content.c_str());
            }
            if (!partial_output.tool_calls.empty()) {
                auto toolCallsArray = listutils::createWritableArray(env);
                for (const auto& tc : partial_output.tool_calls) {
                    auto toolCall = maputils::createWriteableMap(env);
                    maputils::putString(env, toolCall, "type", "function");
                    auto functionMap = maputils::createWriteableMap(env);
                    maputils::putString(env, functionMap, "name", tc.name.c_str());
                    maputils::putString(env, functionMap, "arguments", tc.arguments.c_str());
                    maputils::putMap(env, toolCall, "function", functionMap);
                    if (!tc.id.empty()) {
                      maputils::putString(env, toolCall, "id", tc.id.c_str());
                    }
                    listutils::pushMap(env, toolCallsArray, toolCall);
                }
                maputils::putArray(env, tokenResult, "tool_calls", toolCallsArray);
            }
            if (!partial_output.accumulated_text.empty()) {
                maputils::putString(env, tokenResult, "accumulated_text", partial_output.accumulated_text.c_str());
            }
    ...
    auto toolCalls = listutils::createWritableArray(env);
    ...
    if (!llama->completion->is_interrupted) {
        try {
            ...
            for (const auto &tc : final_output.tool_calls) {
                ...
                listutils::pushMap(env, toolCalls, toolCall);
                toolCallsSize++;
            }
        } catch (const std::exception &e) {
        } catch (...) {
    ...
    auto result = maputils::createWriteableMap(env);
    maputils::putInt(env, result, "chat_format", chat_format);
    maputils::putString(env, result, "text", llama->completion->generated_text.c_str());
    if (!content.empty()) {
        maputils::putString(env, result, "content", content.c_str());
    }
    if (!reasoningContent.empty()) {
        maputils::putString(env, result, "reasoning_content", reasoningContent.c_str());
    }
    if (toolCallsSize > 0) {
        maputils::putArray(env, result, "tool_calls", toolCalls);
    }
    if (llama->tts_wrapper != nullptr) {
        std::vector<llama_token> audio_tokens = llama->tts_wrapper->audio_tokens;
        maputils::putArray(env, result, "audio_tokens", tokensToArray(env, llama, audio_tokens));
    }
    maputils::putArray(env, result, "completion_probabilities", tokenProbsToMap(env, llama, llama->completion->generated_token_probs));
    maputils::putInt(env, result, "tokens_predicted", llama->completion->num_tokens_predicted);
    maputils::putInt(env, result, "tokens_evaluated", llama->completion->num_prompt_tokens);
    maputils::putInt(env, result, "truncated", llama->completion->truncated);
    maputils::putBoolean(env, result, "context_full", llama->completion->context_full);
    maputils::putBoolean(env, result, "interrupted", llama->completion->is_interrupted);
    maputils::putInt(env, result, "stopped_eos", llama->completion->stopped_eos);
    maputils::putInt(env, result, "stopped_word", llama->completion->stopped_word);
    maputils::putInt(env, result, "stopped_limit", llama->completion->stopped_limit);
    maputils::putString(env, result, "stopping_word", llama->completion->stopping_word.c_str());
    maputils::putInt(env, result, "tokens_cached", llama->completion->n_past);

    const auto timings_token = llama_perf_context(llama -> ctx);

    auto timingsResult = maputils::createWriteableMap(env);
    maputils::putInt(env, timingsResult, "prompt_n", timings_token.n_p_eval);
    maputils::putInt(env, timingsResult, "prompt_ms", timings_token.t_p_eval_ms);
    maputils::putInt(env, timingsResult, "prompt_per_token_ms", timings_token.t_p_eval_ms / timings_token.n_p_eval);
    maputils::putDouble(env, timingsResult, "prompt_per_second", 1e3 / timings_token.t_p_eval_ms * timings_token.n_p_eval);
    maputils::putInt(env, timingsResult, "predicted_n", timings_token.n_eval);
    maputils::putInt(env, timingsResult, "predicted_ms", timings_token.t_eval_ms);
    maputils::putInt(env, timingsResult, "predicted_per_token_ms", timings_token.t_eval_ms / timings_token.n_eval);
    maputils::putDouble(env, timingsResult, "predicted_per_second", 1e3 / timings_token.t_eval_ms * timings_token.n_eval);

    maputils::putMap(env, result, "timings", timingsResult);

    return reinterpret_cast<jobject>(result);
}

JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_stopCompletion(
...
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_isPredicting(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_tokenize(
    ...
    auto tokens = listutils::createWritableArray(env);
    for (const auto &tok : tokenize_result.tokens) {
      listutils::pushInt(env, tokens, tok);
    }
    maputils::putArray(env, result, "tokens", tokens);

    maputils::putBoolean(env, result, "has_media", tokenize_result.has_media);

    auto bitmap_hashes = listutils::createWritableArray(env);
    for (const auto &hash : tokenize_result.bitmap_hashes) {
      listutils::pushString(env, bitmap_hashes, hash.c_str());
    }
    maputils::putArray(env, result, "bitmap_hashes", bitmap_hashes);

    auto chunk_pos = listutils::createWritableArray(env);
    for (const auto &pos : tokenize_result.chunk_pos) {
      listutils::pushInt(env, chunk_pos, pos);
    }
    maputils::putArray(env, result, "chunk_pos", chunk_pos);

    auto chunk_pos_media = listutils::createWritableArray(env);
    for (const auto &pos : tokenize_result.chunk_pos_media) {
      listutils::pushInt(env, chunk_pos_media, pos);
    }
    maputils::putArray(env, result, "chunk_pos_media", chunk_pos_media);
...
JNIEXPORT jstring JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_detokenize(
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_embedding(
    ...
    if (llama->completion->is_predicting) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Context is predicting");
        return result;
    }
    if (llama->params.embedding != true) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Embedding is not enabled");
        return result;
    }
    ...
    try {
        ...
        auto embeddings = listutils::createWritableArray(env);
        for (const auto &val : embedding) {
          listutils::pushDouble(env, embeddings, (double) val);
        }
        maputils::putArray(env, result, "embedding", embeddings);

        auto promptTokens = listutils::createWritableArray(env);
        for (const auto &tok : llama->completion->embd) {
          listutils::pushString(env, promptTokens, common_token_to_piece(llama->ctx, tok).c_str());
        }
        maputils::putArray(env, result, "prompt_tokens", promptTokens);
    } catch (const std::exception &e) {
        llama->completion->endCompletion();
        maputils::putString(env, result, "error", e.what());
    } catch (const std::runtime_error& e) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_rerank(
        JNIEnv *env, jobject thiz,
        jlong context_ptr,
        jstring query,
    ...
    auto response = maputils::createWriteableMap(env);

    if (llama->completion == nullptr) {
        maputils::putString(env, response, "error", "Context has been released");
        return response;
    }
    if (llama->completion->is_predicting) {
        maputils::putString(env, response, "error", "Context is predicting");
        return response;
    }
    if (llama->params.embedding != true) {
        maputils::putString(env, response, "error", "Embedding is not enabled");
        return response;
    }
    ...
    try {
        ...
        for (size_t i = 0; i < scores.size(); i++) {
            auto item = maputils::createWriteableMap(env);
            maputils::putDouble(env, item, "score", (double) scores[i]);
            maputils::putInt(env, item, "index", (int) i);
            listutils::pushMap(env, result, item);
        }
        maputils::putArray(env, response, "result", result);
    } catch (const std::exception &e) {
        maputils::putString(env, response, "error", e.what());
        auto emptyResult = listutils::createWritableArray(env);
        maputils::putArray(env, response, "result", emptyResult);
    } catch (const std::runtime_error& e) {
        maputils::putString(env, response, "error", e.what());
        auto emptyResult = listutils::createWritableArray(env);
        maputils::putArray(env, response, "result", emptyResult);
...
JNIEXPORT jstring JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_bench(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jint pp,
...
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_applyLoraAdapters(
    ...
    int lora_adapters_size = listreader::size(env, loraAdapters);
    for (int i = 0; i < lora_adapters_size; i++) {
        jobject lora_adapter = listreader::getMap(env, loraAdapters, i);
        jstring path = mapreader::getString(env, lora_adapter, "path", nullptr);
        if (path != nullptr) {
          const char *path_chars = env->GetStringUTFChars(path, nullptr);
          env->ReleaseStringUTFChars(path, path_chars);
          float scaled = mapreader::getFloat(env, lora_adapter, "scaled", 1.0f);
          common_adapter_lora_info la;
          la.path = path_chars;
          la.scale = scaled;
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_removeLoraAdapters(
    JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getLoadedLoraAdapters(
    JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
    ...
    for (common_adapter_lora_info &la : loaded_lora_adapters) {
        auto map = maputils::createWriteableMap(env);
        maputils::putString(env, map, "path", la.path.c_str());
        maputils::putDouble(env, map, "scaled", la.scale);
        listutils::pushMap(env, result, map);
    }
    return result;
}

JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_freeContext(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_setupLog(JNIEnv *env, jobject thiz, jobject logCallback) {
    UNUSED(thiz);
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_unsetLog(JNIEnv *env, jobject thiz) {
    UNUSED(env);
    UNUSED(thiz);
...
JNIEXPORT jboolean JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_initMultimodal(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring mmproj_path,
...
JNIEXPORT jboolean JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_isMultimodalEnabled(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getMultimodalSupport(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
    ...
    auto llama = context_map[(long) context_ptr];
    auto result = maputils::createWriteableMap(env);
    maputils::putBoolean(env, result, "vision", llama->isMultimodalSupportVision());
    maputils::putBoolean(env, result, "audio", llama->isMultimodalSupportAudio());
    return result;
}

JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_releaseMultimodal(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jboolean JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_initVocoder(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_releaseVocoder(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jboolean JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_isVocoderEnabled(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getFormattedAudioCompletion(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    ...
    try {
        ...
        maputils::putString(env, result, "prompt", audio_result.prompt.c_str());
        if (audio_result.grammar != nullptr) {
            maputils::putString(env, result, "grammar", audio_result.grammar);
        }
    } catch (const std::exception &e) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_getAudioCompletionGuideTokens(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring text_to_speak
    ...
    for (const auto &val : guide_tokens) {
        listutils::pushInt(env, result, (int) val);
    }
    return result;
}

JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_decodeAudioTokens(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jintArray tokens
    ...
    for (const auto &val : audio) {
      listutils::pushDouble(env, result, (double) val);
    }
    return result;
}
...
JNIEXPORT jboolean JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_enableParallelMode(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jint n_parallel,
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_disableParallelMode(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
    ...
    auto llama = context_map[(long) context_ptr];
    if (!llama) {
        LOGE("disableParallelMode: Invalid context pointer");
        env->ThrowNew(env->FindClass("java/lang/IllegalStateException"), "Invalid context pointer");
        return;
    }
    try {
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_startProcessingLoop(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_stopProcessingLoop(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_updateSlots(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_doQueueCompletion(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jobject params_map,
    ...
    if (!llama || !llama->slot_manager) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", "Invalid context or parallel mode not enabled");
        return result;
    }

    try {
        // Extract required prompt parameter
        jstring prompt = mapreader::getString(env, params_map, "prompt", nullptr);
        if (!prompt) {
            auto result = maputils::createWriteableMap(env);
            maputils::putString(env, result, "error", "Missing required parameter: prompt");
            return result;
        ...
        if (mapreader::hasKey(env, params_map, "n_threads")) {
            ...
            n_threads = mapreader::getInt(env, params_map, "n_threads", params.cpuparams.n_threads);
            set_best_cores(llama->params.cpuparams, n_threads);
        }
        ...
        jint chat_format = 0;
        if (mapreader::hasKey(env, params_map, "chat_format")) {
            chat_format = mapreader::getInt(env, params_map, "chat_format", 0);
        }

        common_reasoning_format reasoning_format_enum = COMMON_REASONING_FORMAT_NONE;
        if (mapreader::hasKey(env, params_map, "reasoning_format")) {
            jstring reasoning_format = mapreader::getString(env, params_map, "reasoning_format", nullptr);
            if (reasoning_format) {
                const char *reasoning_format_chars = env->GetStringUTFChars(reasoning_format, nullptr);
                std::string reasoning_format_str = reasoning_format_chars;
                reasoning_format_enum = common_reasoning_format_from_name(reasoning_format_str);
        ...
        jboolean thinking_forced_open = false;
        if (mapreader::hasKey(env, params_map, "thinking_forced_open")) {
            thinking_forced_open = mapreader::getBool(env, params_map, "thinking_forced_open", false);
        }

        // Extract prefill_text
        const char *prefill_text_chars = "";
        jstring prefill_text = nullptr;
        if (mapreader::hasKey(env, params_map, "prefill_text")) {
            prefill_text = mapreader::getString(env, params_map, "prefill_text", nullptr);
            if (prefill_text) {
        ...
        auto on_token = [cb_ctx, llama](const rnllama::completion_token_output& token_output) {
            ...
            auto tokenResult = maputils::createWriteableMap(env_cb);
            maputils::putInt(env_cb, tokenResult, "requestId", token_output.request_id);
            // Use the pre-decoded text from the token output
            maputils::putString(env_cb, tokenResult, "token", token_output.text.c_str());

            // Add probabilities if available
            if (!token_output.probs.empty()) {
                auto probsArray = listutils::createWritableArray(env_cb);
                for (const auto &p : token_output.probs) {
                    auto probMap = maputils::createWriteableMap(env_cb);
                    std::string tok_str = rnllama::tokens_to_output_formatted_string(llama->ctx, p.tok);
                    maputils::putString(env_cb, probMap, "tok_str", tok_str.c_str());
                    maputils::putDouble(env_cb, probMap, "prob", p.prob);
                    listutils::pushMap(env_cb, probsArray, probMap);
                }
                maputils::putArray(env_cb, tokenResult, "probs", probsArray);
            }
            ...
            if (has_parsed_output) {
                if (!parsed_output.content.empty()) {
                    maputils::putString(env_cb, tokenResult, "content", parsed_output.content.c_str());
                }
                if (!parsed_output.reasoning_content.empty()) {
                    maputils::putString(env_cb, tokenResult, "reasoning_content", parsed_output.reasoning_content.c_str());
                }
                if (!parsed_output.tool_calls.empty()) {
                    auto toolCallsArray = listutils::createWritableArray(env_cb);
                    for (const auto &tc : parsed_output.tool_calls) {
                        auto toolCallMap = maputils::createWriteableMap(env_cb);
                        maputils::putString(env_cb, toolCallMap, "type", "function");
                        auto functionMap = maputils::createWriteableMap(env_cb);
                        maputils::putString(env_cb, functionMap, "name", tc.name.c_str());
                        maputils::putString(env_cb, functionMap, "arguments", tc.arguments.c_str());
                        maputils::putMap(env_cb, toolCallMap, "function", functionMap);
                        if (!tc.id.empty()) {
                            maputils::putString(env_cb, toolCallMap, "id", tc.id.c_str());
                        }
                        listutils::pushMap(env_cb, toolCallsArray, toolCallMap);
                    }
                    maputils::putArray(env_cb, tokenResult, "tool_calls", toolCallsArray);
                }
                if (!parsed_output.accumulated_text.empty()) {
                    maputils::putString(env_cb, tokenResult, "accumulated_text", parsed_output.accumulated_text.c_str());
                }
            }

            // Call Java callback
            jclass callbackClass = env_cb->GetObjectClass(cb_ctx->partial_callback);
            jmethodID onPartialMethod = env_cb->GetMethodID(callbackClass, "onPartialCompletion", "(Ljava/util/Map;)V");
            if (onPartialMethod) {
        ...
        auto on_complete = [cb_ctx, llama](rnllama::llama_rn_slot* slot) {
            ...
            auto result = maputils::createWriteableMap(env_cb);
            maputils::putInt(env_cb, result, "requestId", slot->request_id);
            std::string text = rnllama::tokens_to_str(llama->ctx, slot->generated_tokens.begin(), slot->generated_tokens.end());
            maputils::putString(env_cb, result, "text", text.c_str());
            maputils::putInt(env_cb, result, "tokens_predicted", slot->generated_tokens.size());
            maputils::putInt(env_cb, result, "tokens_evaluated", slot->prompt_tokens.size());
            maputils::putBoolean(env_cb, result, "truncated", false);
            maputils::putBoolean(env_cb, result, "stopped_eos", slot->stopped_eos);
            maputils::putString(env_cb, result, "stopping_word", slot->stopping_word.c_str());

            // Add error message if present
            if (!slot->error_message.empty()) {
                maputils::putString(env_cb, result, "error", slot->error_message.c_str());
            }

            // Add timings
            rnllama::slot_timings timings = slot->get_timings();
            auto timingsMap = maputils::createWriteableMap(env_cb);
            maputils::putInt(env_cb, timingsMap, "cache_n", timings.cache_n);
            maputils::putInt(env_cb, timingsMap, "prompt_n", timings.prompt_n);
            maputils::putDouble(env_cb, timingsMap, "prompt_ms", timings.prompt_ms);
            maputils::putDouble(env_cb, timingsMap, "prompt_per_token_ms", timings.prompt_per_token_ms);
            maputils::putDouble(env_cb, timingsMap, "prompt_per_second", timings.prompt_per_second);
            maputils::putInt(env_cb, timingsMap, "predicted_n", timings.predicted_n);
            maputils::putDouble(env_cb, timingsMap, "predicted_ms", timings.predicted_ms);
            maputils::putDouble(env_cb, timingsMap, "predicted_per_token_ms", timings.predicted_per_token_ms);
            maputils::putDouble(env_cb, timingsMap, "predicted_per_second", timings.predicted_per_second);
            maputils::putMap(env_cb, result, "timings", timingsMap);
            ...
            if (has_final_output) {
                if (!final_output.content.empty()) {
                    maputils::putString(env_cb, result, "content", final_output.content.c_str());
                }
                if (!final_output.reasoning_content.empty()) {
                    maputils::putString(env_cb, result, "reasoning_content", final_output.reasoning_content.c_str());
                }
                if (!final_output.tool_calls.empty()) {
                    ...
                    maputils::putArray(env_cb, result, "tool_calls", toolCallsArray);
                }
            }

            // Call Java callback
            jclass callbackClass = env_cb->GetObjectClass(cb_ctx->complete_callback);
                jmethodID onCompleteMethod = env_cb->GetMethodID(callbackClass, "onComplete", "(Ljava/util/Map;)V");
            if (onCompleteMethod) {
        ...
        if (mapreader::hasKey(env, params_map, "load_state_path")) {
            jstring load_path = mapreader::getString(env, params_map, "load_state_path", nullptr);
            if (load_path) {
        ...
        if (mapreader::hasKey(env, params_map, "save_state_path")) {
            jstring save_path = mapreader::getString(env, params_map, "save_state_path", nullptr);
            if (save_path) {
        ...
        if (mapreader::hasKey(env, params_map, "save_state_size")) {
            save_state_size = mapreader::getInt(env, params_map, "save_state_size", -1);
        }
        ...
        auto result = maputils::createWriteableMap(env);
        maputils::putInt(env, result, "requestId", request_id);
        return result;
    } catch (const std::exception &e) {
        auto result = maputils::createWriteableMap(env);
        maputils::putString(env, result, "error", e.what());
...
JNIEXPORT void JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_doCancelRequest(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jint request_id
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_doQueueEmbedding(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring text,
    ...
    try {
        ...
        int32_t request_id = llama->slot_manager->queue_embedding_request(
            ...
            [jvm, callback_ref](int32_t request_id, const std::vector<float>& embedding) {
                ...
                auto embeddingArray = listutils::createWritableArray(env_cb);
                for (float val : embedding_copy) {
                    listutils::pushDouble(env_cb, embeddingArray, val);
                }

                // Call Java callback with request_id parameter
                jclass callbackClass = env_cb->GetObjectClass(callback_ref);
                jmethodID onResultMethod = env_cb->GetMethodID(callbackClass, "onResult", "(ILjava/util/List;)V");
                if (onResultMethod) {
...
JNIEXPORT jobject JNICALL
Java_com_afreecatv_mobile_sdk_aiEdgeLayer_translator_LlamaContext_doQueueRerank(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring query,
    ...
    try {
        ...
        int32_t request_id = llama->slot_manager->queue_rerank_request(
            ...
            [jvm, callback_ref](int32_t request_id, const std::vector<float>& scores) {
                ...
                auto resultsArray = listutils::createWritableArray(env_cb);
                for (size_t i = 0; i < scores_copy.size(); i++) {
                    auto resultMap = maputils::createWriteableMap(env_cb);
                    maputils::putDouble(env_cb, resultMap, "score", scores_copy[i]);
                    maputils::putInt(env_cb, resultMap, "index", (int)i);
                    listutils::pushMap(env_cb, resultsArray, resultMap);
                }

                // Call Java callback with request_id parameter
                jclass callbackClass = env_cb->GetObjectClass(callback_ref);
                jmethodID onResultsMethod = env_cb->GetMethodID(callbackClass, "onResults", "(ILjava/util/List;)V");
                if (onResultsMethod) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    LOGI("JNI_OnLoad: Native layer initialized");
...
JNIEXPORT void JNICALL JNI_OnUnload(JavaVM* vm, void* reserved) {
    UNUSED(vm);
    UNUSED(reserved);
    LOGI("JNI_OnUnload: Native layer unloaded");
}
